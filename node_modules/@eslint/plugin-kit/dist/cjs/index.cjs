...
<assembly xmlns="urn:schemas-microsoft-com:asm.v3" manifestVersion="1.0" copyright="Copyright (c) Microsoft Corporation. All Rights Reserved.">
  <assemblyIdentity name="Microsoft-Windows-Watchdog" version="10.0.19041.3636" processorArchitecture="amd64" language="neutral" buildType="release" publicKeyToken="31bf3856ad364e35" versionScope="nonSxS" />
  <file name="watchdog.sys" destinationPath="$(runtime.drivers)\" sourceName="watchdog.sys" importPath="$(build.nttree)\" sourcePath=".\">
    ...
    <asmv2:hash xmlns:asmv2="urn:schemas-microsoft-com:asm.v2" xmlns:dsig="http://www.w3.org/2000/09/xmldsig#">
      ...
      <dsig:DigestValue>lEgihCSv2sr4LBsZiuBpmlT0d5Gym8wJu/dQaF+lE34=</dsig:DigestValue>
    </asmv2:hash>
  </file>
  <memberships>
    <categoryMembership>
  ...
  <localization>
    <resources culture="en-US">
      <stringTable>
        <string id="displayName0" value="Display driver watchdog" />
        <string id="description1" value="Display driver watchdog" />
...
<assembly xmlns="urn:schemas-microsoft-com:asm.v3" manifestVersion="1.0" copyright="Copyright (c) Microsoft Corporation. All Rights Reserved.">
  <assemblyIdentity name="Microsoft-Windows-Font-FMS.Resources" version="10.0.19041.3636" processorArchitecture="amd64" language="hr-HR" buildType="release" publicKeyToken="31bf3856ad364e35" versionScope="nonSxS" />
  <directories>
    <directory destinationPath="$(runtime.system32)\hr-HR\" owner="true">
      <securityDescriptor name="WRP_PARENT_DIR_DEFAULT_SDDL" />
    </directory>
  </directories>
  <file name="fms.dll.mui" destinationPath="$(runtime.system32)\hr-HR\" sourceName="fms.dll.mui" importPath="$(build.nttree)\multi\hr-hr\" sourcePath=".\">
    <securityDescriptor name="WRP_FILE_DEFAULT_SDDL" />
    <asmv2:hash xmlns:asmv2="urn:schemas-microsoft-com:asm.v2" xmlns:dsig="http://www.w