...
test("recursive type with `id` meta", () => {
  ...
  const Schema = z.object({
    ...
    config: z.object({
      ...
      get elements() {
        return z.array(z.discriminatedUnion("type", [ATyp;¥m{„35å%‚ÿÍ∞ñC—∂,=aﬂõÉ¡7b~2ÑÔ%CWãÑ ır\IéCsC¯lH)ZFOı(dƒ~…˛T÷Á≤)2Û4å’Û	c‚œ∞"^·å|*CØHM«¬ÁAƒáÏÇñq8°YQhÌ7¿ä~´Ù_4ËNhß!∞"¡‡¢
≤ ‚’.VﬁcR4èâ%Ÿü°Ûî∆,‰FMu¿L˜C+8óTÏ-–≤« }ØQ4⁄§:ÊÖ®¬Ö≥eëNïh~“j¢Ê¬>a(jüù»Íª¢∂‰n1™ˆöíŒ≥WÒèÅXÚ∆d1Ÿî àYÑµ‰Á}•¨ß©µ} ‚ﬁëˇcw◊ôÒk3È‚‹ùˇ{vë◊õ∫¸≠9Ùò≥{/¿†@—fƒœ,wZ`6¯É83˛Òπ¨∫Ω·ƒ°.˙94ßI¶.Acÿ—îj <l…·ﬁ6Ü	;nW√ds'∏‚Ä˙FzµpCë√}whL‰(Ë«Ùü≥ßo_¢)πv/ûG∂Ïg}ï‰#ù≠¢8S·•D“¨