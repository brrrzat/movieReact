module.exports = {
	...
	"34.5.1": اسية وقم بتحديث إعداداتك هناك.تحرير النسقاستعراض المزيد من النسق التي تم إنشاؤها خصيصا لـ Edgeتخصيص الأزرار التي تظهر دائما على المستعرضتحديد الأزرار التي تريد إظهارها على شريط الأدواتخطوطقد تعمل تفضيلات الخط على بعض مواقع الويب فقطتمكين تقسيم الشاشةتعدد المهام بكفاءة عبر الشاشات جنبا إلى جنب على علامة تبويب واحدة للاستعراض.اسحب علامة التبويب لفتحها مع تقسيم الشاشةاسحب علامة التبويب وقم بإفلاتها في منطقة تقسيم الشاشة إلى جانب آخر علامة تبويب نشطةتكوين تقسيم الشاشةقم بتشغيل/إيقاف تشغيل تقسيم الشاشة، وتكوين الإعدادات المتقدمة.دائماً في وضع التشغيلسيظهر الشريط الجانبي دائمامخفي تلقائياسيظهر الشريط الجانبي عند استخدام الجزء الجانبي؛ يمكنك الوصول إليه من أيقونة Copilotلن يظهر الشريط الجانبي أبداإظهار زر "الشريط الجانبي"Dropإظهار قائمة إجراءات علامة التبويبإظهار بحث علامة التبويبزر الشبكة الآمنة (VPN)إخفاء شريط العنوان أثناء وجوده في علامات التبويب العموديةإظهار معاينة علامة التبويب عند التمريرسلوكاسحب لتجميع علامات التبويبيظهر الزر "للأمام" تلقائيًا في شريط الأدوات عندما يكون من الممكن الانتقال إلى الأمام.الإظهار دائماًالإظهار تلقائيًايظهر زر الملحقات تلقائيا في شريط الأدوات عند تشغيل ملحق واحد أو أكثر.لا تعرضهالإظهار زر "وضع Internet Explorer" ، قم بتشغيل $1السماح باعاده تحميل المواقع في وضع Internet Explorerإظهار شريط التمرير دائمًااسمح لتطبيقات الشريط الجانبي بإظهار الإشعاراتإضفاء طابع شخصي على أكثر المواقع زيارة لدي في تخصيص الشريط الجانبيسنقوم بتخصيص أفضل المواقع المعروضة في جزء التخصيص استنادا إلى محفوظات الاستعراض والأنشطةشكرًا! هل تريد منا إيقاف فتح بريدك الإلكتروني في جزء Outlook؟شكراً! هل تريد منا التوقف عن فتح دردشتك في جزء Teams؟تحويل الكتابة اليدوية إلى نص في حقول الإدخال.سيؤدي استخدام قلم معتمد للكتابة باليد في حقول نص الإدخال إلى تحويل الضغطات تلقائيا إلى نص مكتوب. لاحظ أن هذا الأمر خاص بدعم نظام التشغيل (والذي يمكنك التحقق منه بالانتقال إلى الإعدادات > أجهزة Bluetooth & > القلم & Windows Ink > Shell بخط اليد).الكتابة باليد إلى نصالسلوك العامإيماءة الماوستنسيق عنوان ويبشريط مهام Windowsتغيير تنسيق نسخ عنوان URL ولصقهتعيين عنوان URL لزر الصفحة الرئيسيةوضع Internet Explorer (وضع IE)ملاحظاتمربع بحث إضافيCopilot والشريط الجانبيمساعد الذكاء الاصطناعي والشريط الجانبيإدارة أذونات الموقعإدارة أذونات الويب مثل الموقع والميكروفون وما إلى ذلك على صفحة أذونات الموقعإعدادات التطبيقات المحددةالتطبيقات الأخرىيحتوي كل تطبيق على إعدادات مستقلة يمكن تعيينها �alpha.5": "140.0.7261.0",
